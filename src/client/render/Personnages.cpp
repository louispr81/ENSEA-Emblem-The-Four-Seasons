...
bool Personnages::load(const std::string& tileset, sf::Vector2u tileSize, std::vector<int> tiles, unsigned int nbrPersonnages)

{
    ...
    for (unsigned int i = 0; i < nbrPersonnages; ++i)
